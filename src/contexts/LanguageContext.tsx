...
const translations = {
  en: {
    ...
    'footer.description': 'Your trusted partner for certified medical equipment. Quality instruments from verified sellers with full warranty support.',
    'footer.quickLinks': 'Quick Links',
    'footer.browseEquipment': 'Browse Equipment',
    'footer.sellEquipment': 'Sell Equipment',
    'footer.financingOptions': 'Financing Options',
    'footer.warrantyInfo': 'Warranty Info',
    'footer.supportCenter': 'Support Center',
    'footer.popularCategories': 'Popular Categories',
    'footer.diagnosticEquipment': 'Diagnostic Equipment',
    'footer.patientMonitoring': 'Patient Monitoring',
    'footer.laboratory': 'Laboratory',
    'footer.imagingEquipment': 'Imaging Equipment',
    'footer.surgicalInstruments': 'Surgical Instruments',
    'footer.businessHours': 'Business Hours',
    'footer.mondayFriday': 'Monday - Friday: 9:00 - 18:00',
    'footer.saturday': 'Saturday: Closed',
    'footer.sunday': 'Sunday: Closed',
    'footer.copyright': '© 2024 AvtoMed. All rights reserved. | ISO 13485 Certified | FDA Registered',
    'footer.privacyPolicy': 'Privacy Policy',
    'footer.termsOfService': 'Terms of Service',
    'footer.cookiePolicy': 'Cookie Policy',
    'footer.address': 'Lubliana St. 38b, Tbilisi, Georgia',
  ...
  ka: {
    ...
    'footer.description': 'თქვენი სანდო პარტნიორი სერტიფიცირებული სამედიცინო აღჭურვილობისთვის. ხარისხიანი ინსტრუმენტები გადამოწმებული გამყიდველებისგან სრული გარანტიით.',
    'footer.quickLinks': 'სწრაფი ბმულები',
    'footer.browseEquipment': 'აღჭურვილობის დათვალიერება',
    'footer.sellEquipment': 'აღჭურვილობის გაყიდვა',
    'footer.financingOptions': 'დაფინანსების ვარიანტები',
    'footer.warrantyInfo': 'გარანტიის ინფორმაცია',
    'footer.supportCenter': 'მხარდაჭერის ცენტრი',
    'footer.popularCategories': 'პოპულარული კატეგორიები',
    'footer.diagnosticEquipment': 'დიაგნოსტიკური აღჭურვილობა',
    'footer.patientMonitoring': 'პაციენტის მონიტორინგი',
    'footer.laboratory': 'ლაბორატორია',
    'footer.imagingEquipment': 'ვიზუალიზაციის აღჭურვილობა',
    'footer.surgicalInstruments': 'ქირურგიული ინსტრუმენტები',
    'footer.businessHours': 'სამუშაო საათები',
    'footer.mondayFriday': 'ორშაბათი - პარასკევი: 9:00 - 18:00',
    'footer.saturday': 'შაბათი: დახურულია',
    'footer.sunday': 'კვირა: დახურულია',
    'footer.copyright': '© 2024 ავთომედი. ყველა უფლება დაცულია. | ISO 13485 სერტიფიცირებული | FDA რეგისტრირებული',
    ...
    'footer.address': 'ლუბლიანას ქ. 38ბ, თბილისი, საქართველო',
